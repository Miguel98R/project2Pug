...
function replacePathsInPugFiles(rootDir) {
...
function getAllFilesInDir(dir, ext) {
    let files = [];
...
function removePugFromFileRoutes(filepath) {
...
function CreateFoldersInPug_out(filepath) {
